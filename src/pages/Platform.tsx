...
import { Brain, Phone, Bot, Workflow, PieChart, Server, Globe, Shield, Code, Zap, ArrowRight, Megaphone } from "lucide-react";
...
const pillars = [
  ...
  { icon: Megaphone, title: "Marketing Automation", desc: "Omnichannel campaign orchestration with AI-powered audience segmentation, personalized messaging, and attribution modeling." },
...
const techFeatures = [
  ...
  { icon: Shield, title: "Enterprise Security", desc: "End-to-end encryption, role-based access control, and audit logs for full compliance." },
  ...
  <div className="overflow-hidden">
    <section className="gradient-hero pt-32 pb-20 relative">
      ...
      <div className="container-wide text-center relative z-10">
        <AnimatedSection>
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase mb-6 bg-teal/10 text-teal-light border border-teal/20">Platform</span>
          ...
          {techFeatures.map((f, i) => (
            <AnimatedSection key={f.title} delay={i * 0.1}>
              <div className="glass-card-hover rounded-2xl p-8 h-full flex gap-5">
                <div className="feature-icon-box shrink-0"><f.icon size={22} className="text-teal-light" /></div>
                <div>
